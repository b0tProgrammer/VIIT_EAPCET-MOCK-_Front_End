...
  CalendarDays as CalendarIcon, 
  Menu as MenuIcon, // <-- 3. Import MenuIcon
} from 'lucide-react';

// --- Centralized Data Store ---
const allExamData = {
  // ... (your exam data is unchanged)
  "Mock_Exam_20": { examName: "Mock_Exam_20", date: "01 Nov 2025", score: "112 / 160", timeTaken: "2h 45m", accuracy: "78%", rank: "23 / 240", percentile: "90.4%", mathsScore: 70, physicsScore: 62, chemistryScore: 33, insights: ["Insight 1", "Insight 2"] },
  "Mock_Exam_19": { examName: "Mock_Exam_19", date: "25 Oct 2025", score: "105 / 160", timeTaken: "2h 50m", accuracy: "72%", rank: "45 / 240", percentile: "81.2%", mathsScore: 60, physicsScore: 55, chemistryScore: 40, insights: ["Insight 1", "Insight 2"] },
  "Mock_Exam_18": { examName: "Mock_Exam_18", date: "18 Oct 2025", score: "98 / 160", timeTaken: "2h 40m", accuracy: "68%", rank: "67 / 240", percentile: "72.0%", mathsScore: 50, physicsScore: 45, chemistryScore: 48, insights: ["Insight 1", "Insight 2"] },
  "Mock_Exam_17": { examName: "Mock_Exam_17", date: "11 Oct 2025", score: "110 / 160", timeTaken: "2h 48m", accuracy: "75%", rank: "31 / 240", percentile: "87.0%", mathsScore: 65, physicsScore: 60, chemistryScore: 45, insights: ["Insight 1", "Insight 2"] }
};
...
                  <span className="text-gray-500">60</span><span className="text-gray-500">40</span><span className="text-gray-500">20</span><span className="text-gray-500">0</span>
                </div>
...
// ... (AccordionItem, StatItem, and Bar components are unchanged)
function AccordionItem({ examName, data, isOpen, onToggle, onViewReport }) {
  return (
    <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
      <button onClick={onToggle} className="w-full flex justify-between items-center p-5 cursor-pointer hover:bg-gray-50 transition-colors">
        <span className="text-xl font-semibold text-gray-700">Results For {examName}</span>
        {isOpen ? <Minus size={24} className="text-blue-600" /> : <Plus size={24} className="text-blue-600" />}
      </button>
...
          <button onClick={onViewReport} className="text-blue-600 hover:underline mt-2 inline-block font-medium">
...
        <div className={`w-full rounded-t-lg ${color} hover:opacity-90 transition-all`} style={{ height: `${heightPercent}%` }}>
        </div>
      </div>
